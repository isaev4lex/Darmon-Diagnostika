...
class CardiologyItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид кардиологических исследований'
        verbose_name_plural = 'Виды кардиологических исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("cardiology_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("cardiology_slug_uz", args=[self.slug])
