...
def neuropathologist_kids_ru(request):
    ...
    return render(request, 'neuropathologist_kids/index.html', context=data)


def neuropathologist_kids_uz(request):
    data = {
        'meta': MetaTags.objects.all(),
        'favicons': settings.Favicon.objects.all(),
        'head_tags': settings.HeadTags.objects.all(),
