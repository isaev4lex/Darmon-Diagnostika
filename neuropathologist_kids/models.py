...
class NeuropathologistKidsItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Текст для страницы детский невропотолог'
        verbose_name_plural = 'Текста для страницы детский невропотолог'
