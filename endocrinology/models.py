...
class EndocrinologyItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид эндокринологических исследований'
        verbose_name_plural = 'Виды эндокринологических исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("endocrinology_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("endocrinology_slug_uz", args=[self.slug])
