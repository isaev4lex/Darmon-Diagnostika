...
def stomatology_ru(request):
    ...
    return render(request, 'stomatology/index.html', context=data)


def stomatology_uz(request):
    data = {
        'meta': MetaTags.objects.all(),
        'favicons': settings.Favicon.objects.all(),
        'head_tags': settings.HeadTags.objects.all(),
