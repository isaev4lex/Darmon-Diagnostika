...
class UrologyItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид урологических исследований'
        verbose_name_plural = 'Виды урологических исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("urology_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("urology_slug_uz", args=[self.slug])
