...
class UziItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид ультразвуковых исследований'
        verbose_name_plural = 'Виды ультразвуковых исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("uzi_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("uzi_slug_uz", args=[self.slug])
