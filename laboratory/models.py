...
class LabItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид лаборатоных исследований'
        verbose_name_plural = 'Виды лаборатоных исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("lab_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("lab_slug_uz", args=[self.slug])
