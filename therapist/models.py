...
class TherapistItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Информацию для страницы терапевт'
        verbose_name_plural = 'Информация для страницы терапевт'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("therapist_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("therapist_slug_uz", args=[self.slug])
