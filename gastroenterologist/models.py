...
class GastroenterologistItem(models.Model):
    ...
    def get_url_ru(self):
        return reverse("gastroenterologist_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("gastroenterologist_slug_uz", args=[self.slug])
