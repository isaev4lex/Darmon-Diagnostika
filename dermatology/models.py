...
class DermatologyItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид дерматологических исследований'
        verbose_name_plural = 'Виды дерматологических исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("dermatology_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("dermatology_slug_uz", args=[self.slug])
