...
class ProctologyItem(models.Model):
    ...
    class Meta:
        verbose_name = 'Вид проктологических исследований'
        verbose_name_plural = 'Виды проктологических исследований'

    def __str__(self):
        return self.title_ru

    def get_url_ru(self):
        return reverse("proctology_slug_ru", args=[self.slug])

    def get_url_uz(self):
        return reverse("proctology_slug_uz", args=[self.slug])
